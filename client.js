...
const certs = require('./digital-certs/certs');
...
var cert = new Cert(certParams.id, certParams.epn, certParams.name, certParams.password);
...
var options = {
	...
	headers: {
		'Method': 'GET',
		'Path': '/v1/rest/payroll/' + cert.epn + '/' + 2018 + '/Payroll1/submission01?softwareUsed=SOftwareABC&softwareVersion=1.0.0',
